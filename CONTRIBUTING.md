...
Ce dépôt est le canal de livraison de la page d'attente d'ExoTradingPlus! destinée à `exotradingplus.com` (le site complet repart au lancement). Il contient ce qui part en
production, pas le projet : le site se développe dans le vault Obsidian et se
publie par `(C) publier.ps1` du dossier `05 Projets/ExoTradingPlus!` du vault. Ce guide fixe ce qui se passe entre un commit
et la mise en ligne.
